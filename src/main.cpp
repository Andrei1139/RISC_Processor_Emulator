...
volatile uint8_t instructionCount = 0, currentMode = 0;

volatile Instruction instructions[128];
short registers[16];
short outRegister;

volatile bool displayModified = true;
volatile bool runProgram = true;
volatile int currentElement = DEFAULT;
...
// PD6 - Go backwards through elements
ISR(PCINT22_vec) {
